...
var isoCountryCodeConverter = function countryCodeConverter() {

    var fnCountriesArrayLength = undefined,
        fnCheckArgumentIsUndefined = undefined,
        fnNotFoundMessage = undefined,
        fnConvertCodes = undefined,
        fnConvertTwoDigitToThree = undefined,
        fnConvertThreeDigitToTwo = undefined;
    ...
    fnCountriesArrayLength = function fnCountriesArrayLength() {
    ...
    fnCheckArgumentIsUndefined = function fnCheckArgumentIsUndefined(argument) {
    ...
    fnNotFoundMessage = function fnNotFoundMessage() {
        console.log('Country not found in the array, returning original...');
    };

    fnConvertCodes = function fnConvertCodes(sDigit) {
        var i = 0,
            iFound = false,
    ...
    fnConvertTwoDigitToThree = function fnConvertTwoDigitToThree(sTwoDigit) {
        return fnConvertCodes(sTwoDigit);
    };

    fnConvertThreeDigitToTwo = function fnConvertThreeDigitToTwo(sThreeDigit) {
...
//# sourceMappingURL=iso-country-code-converter.js.map