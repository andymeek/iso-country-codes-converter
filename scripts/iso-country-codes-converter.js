/*
    Author: Andy Meek - uandi-digital.com
*/
var isoCountryCodeConverter = function countryCodeConverter() {

    var aCountries, fnCountriesArrayLength, fnCheckArgumentIsUndefined, fnNotFoundMessage, fnConvertCodes, fnConvertTwoDigitToThree, fnConvertThreeDigitToTwo;
    ...
    fnCountriesArrayLength = function countriesArrayLength() {
    ...
    fnCheckArgumentIsUndefined = function (argument) {
    ...
    fnNotFoundMessage = function notFoundMessage() {
        console.log('Country not found in the array, returning original...');
    };

    fnConvertCodes = function convertCodes(sDigit) {
        var i = 0,
            iFound = false,
    ...
    fnConvertTwoDigitToThree = function convertTwoDigitToThree(sTwoDigit) {
        return fnConvertCodes(sTwoDigit);
    };

    fnConvertThreeDigitToTwo = function convertThreeDigitToTwo(sThreeDigit) {
